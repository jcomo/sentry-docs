...
Hover over specific dates and times in the overview graph for a quick perspective of events that crashed, behaved abnormally, errored, or are healthy, as defined for [Release Health](/product/releases/health/). Markers will also be displayed here marking adoption stage changes when viewing a time period where that is applicable (and filtering by a single environment).
